...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['owner_id'], ['owner.id'], name=op.f('fk_car_owner_id_owner'), ondelete='RESTRICT'),
    ...
    sa.ForeignKeyConstraint(['car_id'], ['car.id'], name=op.f('fk_claim_car_id_car'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['car_id'], ['car.id'], name=op.f('fk_insurance_policy_car_id_car'), ondelete='CASCADE'),
